...
const themes: ThemeOption[] = [
  ...
  { id: 'supaclean', labelEs: 'Supabase Claro', labelEn: 'Supabase Clean', mode: 'light' },
...
export const ThemeSelector: React.FC = () => {
  ...
  const groupLabelDark =
    language === 'en' ? 'Dark themes' : 'Temas oscuros';
  const groupLabelLight =
    language === 'en' ? 'Light themes' : 'Temas claros';
  ...
  const renderThemeButton = (th: ThemeOption) => {
    ...
    return (
      <button
        ...
        type="button"
        className={
          'theme-pill' + (isActive ? ' theme-pill--active' : '')
        }
  ...
  return (
    <section className="section theme-selector">
